...
import 'package:serverpod_auth_core_server/serverpod_auth_core_server.dart'
    as _i4;
import 'package:siakad_backend_server/src/generated/greetings/greeting.dart'
    as _i5;
import 'package:siakad_backend_server/src/generated/protocol.dart';
import 'package:siakad_backend_server/src/generated/endpoints.dart';
...
class TestEndpoints {
  ...
  late final _SiakadStateEndpoint siakadState;
}
...
class _InternalTestEndpoints extends TestEndpoints
  ...
  void initialize(
    ...
    siakadState = _SiakadStateEndpoint(
      endpoints,
      serializationManager,
    );
  }
...
class _SiakadStateEndpoint {
  _SiakadStateEndpoint(
    this._endpointDispatch,
    this._serializationManager,
  );
  ...
  _i3.Future<String?> getState(_i1.TestSessionBuilder sessionBuilder) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
            endpoint: 'siakadState',
            method: 'getState',
          );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'siakadState',
          methodName: 'getState',
          parameters: _i1.testObjectToJson({}),
          serializationManager: _serializationManager,
        );
    ...
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      ...
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          ...
          parameters: _i1.testObjectToJson({'stateJson': stateJson}),
          serializationManager: _serializationManager,
        );
        var _localReturnValue =
            await (_localCallContext.method.call(
  ...
  _i3.Future<void> applyRowChanges(
    ...
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
            endpoint: 'siakadState',
            method: 'applyRowChanges',
          );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'siakadState',
          methodName: 'applyRowChanges',
          parameters: _i1.testObjectToJson({
