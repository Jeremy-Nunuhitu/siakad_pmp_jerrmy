...
class Endpoints extends _i1.EndpointDispatch {
  ...
  void initializeEndpoints(_i1.Server server) {
    var endpoints = <String, _i1.Endpoint>{
      ...
      'siakadState': _i5.SiakadStateEndpoint()
        ..initialize(
          server,
          'siakadState',
          null,
    ...
    connectors['siakadState'] = _i1.EndpointConnector(
      name: 'siakadState',
      endpoint: endpoints['siakadState']!,
      methodConnectors: {
        ...
        'saveState': _i1.MethodConnector(
          name: 'saveState',
          params: {
            'stateJson': _i1.ParameterDescription(
              name: 'stateJson',
              type: _i1.getType<String>(),
              nullable: false,
            ),
