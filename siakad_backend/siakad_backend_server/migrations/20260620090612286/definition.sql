...
--
-- Class SiakadState as table siakad_state
--
CREATE TABLE "siakad_state" (
...
--
-- MIGRATION VERSION FOR siakad_backend
--
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('siakad_backend', '20260620090612286', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260620090612286', "timestamp" = now();
